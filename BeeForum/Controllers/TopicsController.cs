...
namespace BeeForum.Controllers
{
    ...
    {
        private readonly BeeForumDbContext _context;

        public TopicsController(BeeForumDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Topic>> PostTopic(Topic topic)
        {
          if (_context.Topics == null)
          {
              return Problem("Entity set 'BeeForumDbContext.Topics'  is null.");
          }
